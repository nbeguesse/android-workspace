 ...
 * {@link CarDetailActivity} representing item details. On tablets, the activity
 * presents the list of items and item details side-by-side using two vertical
 * panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link CarListFragment} and the item details (if present) is a
...
public class CarListActivity extends FragmentActivity implements
	...
	/**
	 * Callback method from {@link CarListFragment.Callbacks} indicating that
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.car_detail_container, fragment).commit();
